...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        ...
        case 6:
            ...
            photo = [MWPhoto photoWithURL:[NSURL URLWithString:@"http://player.vimeo.com/video/29985881"]];
            photo.caption = @"Tube";
            [photos addObject:photo];
            [thumbs addObject:[MWPhoto photoWithURL:[NSURL URLWithString:@"http://farm3.static.flickr.com/2449/4052876281_6e068ac860_q.jpg"]]];
            
            photo = [MWPhoto photoWithURL:[NSURL URLWithString:@"https://www.youtube.com/watch?v=c52TnapDrcM"]];
            photo.caption = @"Tube";
            [photos addObject:photo];
            [thumbs addObject:[MWPhoto photoWithURL:[NSURL URLWithString:@"https://ci3.googleusercontent.com/proxy/hs1irbz7Z5pX0_PuzxCey_eR4vk5DwCs7mcJSVa2lkCGzbHJFlguhFGu18W3CRne5H6FlY2CMq-4siQrdXEMN8qsZetUWw=nu"]]];
